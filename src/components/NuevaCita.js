...
class NuevaCita extends Component {
    ...
    handleSubmit = (e) => {
        ...
        const { mascota, propietario, fecha, hora, sintoma  } = this.state.cita
            ...
            <div className="card mt-5 py-5">
                <div className="card-body">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <input type="submit" className='py- mt-2 btn btn-success btn-block' value='Agregar Nueva cita' />
                    </form>
                </div>
            </div>
        );
